...
public class HuffmanEncoder implements huffmanSignatur{
	...
	public HuffmanEncoder(String txt){
		loadFile(txt);
		}
	...
	public boolean encodeFile() throws Exception{
  		...
  		try
		{
			...
			Summary += ("Original File Size : "+ fileLen + "\n");
		...
		Summary += ("Distinct Chars " + distinctChars + "\n");
		/*
